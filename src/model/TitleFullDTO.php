...
/**
 * TitleFullDTO Class Doc Comment
 *
 * @category    Class */
 // @description TitleFullDTO
/** 
 * @package     de\addvideo\client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TitleFullDTO implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'TitleFullDTO';
    ...
    /**
     * Sets label
     * @param string $label Label of title. String value must not exceed 16 bytes of ASCII characters.
     * @return $this
     */
