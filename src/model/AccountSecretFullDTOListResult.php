...
/**
 * AccountSecretFullDTOListResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     de\addvideo\client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AccountSecretFullDTOListResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'AccountSecretFullDTOListResult';
    ...
    protected static $swaggerTypes = array(
        'accountSecrets' => '\de\addvideo\client\model\AccountSecretFullDTO[]'
    );
    ...
    protected static $setters = array(
        'accountSecrets' => 'setAccountSecrets'
    );
    ...
    protected static $getters = array(
        'accountSecrets' => 'getAccountSecrets'
    );
    ...
    {
        $this->container['accountSecrets'] = isset($data['accountSecrets']) ? $data['accountSecrets'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountSecrets'] === null) {
            $invalid_properties[] = "'accountSecrets' can't be null";
        }
     ...
     */
    public function getAccountSecrets()
    {
        return $this->container['accountSecrets'];
    }

    /**
     * Sets accountSecrets
     * @param \de\addvideo\client\model\AccountSecretFullDTO[] $accountSecrets List of entity objects.
     * @return $this
     */
    public function setAccountSecrets($accountSecrets)
    {
        $this->container['accountSecrets'] = $accountSecrets;
