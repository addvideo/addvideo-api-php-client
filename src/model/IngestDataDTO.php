...
/**
 * IngestDataDTO Class Doc Comment
 *
 * @category    Class */
 // @description Necessary data for ingesting video into the platform.
/** 
 * @package     de\addvideo\client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IngestDataDTO implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'IngestDataDTO';
    ...
    protected static $swaggerTypes = array(
        'entries' => '\de\addvideo\client\model\IngestDataEntryDTO[]'
    );
    ...
    /**
     * Gets entries
     * @return \de\addvideo\client\model\IngestDataEntryDTO[]
     */
    ...
    /**
     * Sets entries
     * @param \de\addvideo\client\model\IngestDataEntryDTO[] $entries Set of entries containing data for ingest jobs.
     * @return $this
     */
