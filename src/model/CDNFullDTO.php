 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CDNFullDTO implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CDNFullDTO';
    ...
    /**
     * Sets name
     * @param string $name Name of CDN. String value must not exceed 64 bytes of ASCII characters.
     * @return $this
     */
