...
/**
 * EntryFullDTOListResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     de\addvideo\client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EntryFullDTOListResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'EntryFullDTOListResult';
    ...
    protected static $swaggerTypes = array(
        'entries' => '\de\addvideo\client\model\EntryFullDTO[]'
    );
    ...
    /**
     * Sets entries
     * @param \de\addvideo\client\model\EntryFullDTO[] $entries List of entity objects.
     * @return $this
     */
