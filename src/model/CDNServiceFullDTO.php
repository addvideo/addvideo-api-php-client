...
/**
 * CDNServiceFullDTO Class Doc Comment
 *
 * @category    Class */
 // @description CDNServiceFullDTO
/** 
 * @package     de\addvideo\client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CDNServiceFullDTO implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CDNServiceFullDTO';
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'contractLineId' => 'int',
        'cdnAccount' => '\de\addvideo\client\model\CDNAccountIdDTO',
        'startDate' => '\DateTime',
        'endDate' => '\DateTime',
        'description' => 'string',
        'label' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cdnAccount'] = isset($data['cdnAccount']) ? $data['cdnAccount'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cdnAccount'] === null) {
            $invalid_properties[] = "'cdnAccount' can't be null";
        }
    ...
    /**
     * Gets cdnAccount
     * @return \de\addvideo\client\model\CDNAccountIdDTO
     */
    public function getCdnAccount()
    {
        return $this->container['cdnAccount'];
    }

    /**
     * Sets cdnAccount
     * @param \de\addvideo\client\model\CDNAccountIdDTO $cdnAccount Internal reference id to Account for CDN to be used.
     * @return $this
     */
    public function setCdnAccount($cdnAccount)
    {
        $this->container['cdnAccount'] = $cdnAccount;
