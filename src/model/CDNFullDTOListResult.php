...
/**
 * CDNFullDTOListResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     de\addvideo\client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CDNFullDTOListResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CDNFullDTOListResult';
    ...
    protected static $swaggerTypes = array(
        'cdns' => '\de\addvideo\client\model\CDNFullDTO[]'
    );
    ...
    {
        $this->container['cdns'] = isset($data['cdns']) ? $data['cdns'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cdns'] === null) {
            $invalid_properties[] = "'cdns' can't be null";
        }
    ...
    {
        return $this->container['cdns'];
    }

    /**
     * Sets cdns
     * @param \de\addvideo\client\model\CDNFullDTO[] $cdns List of entity objects.
     * @return $this
     */
    public function setCdns($cdns)
    {
        $this->container['cdns'] = $cdns;
