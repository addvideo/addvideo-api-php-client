...
/**
 * FlavorFullDTO Class Doc Comment
 *
 * @category    Class */
 // @description FlavorFullDTO
/** 
 * @package     de\addvideo\client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FlavorFullDTO implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'FlavorFullDTO';
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'encodingFlavor' => '\de\addvideo\client\model\EncodingFlavorIdDTO',
        'readyDate' => '\DateTime',
        'completedExportsIds' => '\de\addvideo\client\model\CompletedExportIdDTO[]',
        'deleted' => 'bool',
    ...
    protected static $attributeMap = array(
        'id' => 'id',
        'encodingFlavor' => 'encoding-flavor',
        'readyDate' => 'ready-date',
        'completedExportsIds' => 'completed-exports-ids',
        'deleted' => 'deleted',
    ...
    protected static $setters = array(
        'id' => 'setId',
        'encodingFlavor' => 'setEncodingFlavor',
        'readyDate' => 'setReadyDate',
        'completedExportsIds' => 'setCompletedExportsIds',
        'deleted' => 'setDeleted',
    ...
    protected static $getters = array(
        'id' => 'getId',
        'encodingFlavor' => 'getEncodingFlavor',
        'readyDate' => 'getReadyDate',
        'completedExportsIds' => 'getCompletedExportsIds',
        'deleted' => 'getDeleted',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['encodingFlavor'] = isset($data['encodingFlavor']) ? $data['encodingFlavor'] : null;
        $this->container['readyDate'] = isset($data['readyDate']) ? $data['readyDate'] : null;
        $this->container['completedExportsIds'] = isset($data['completedExportsIds']) ? $data['completedExportsIds'] : null;
     ...
     */
    public function getEncodingFlavor()
    {
        return $this->container['encodingFlavor'];
    }

    /**
     * Sets encodingFlavor
     * @param \de\addvideo\client\model\EncodingFlavorIdDTO $encodingFlavor Internal reference id to Encoding flavor this entry flavor was encoded in.
     * @return $this
     */
    public function setEncodingFlavor($encodingFlavor)
    {
        $this->container['encodingFlavor'] = $encodingFlavor;
    ...
    {
        return $this->container['readyDate'];
    }

    /**
     * Sets readyDate
     * @param \DateTime $readyDate Date flavor became ready for playout. Format as defined in <a href='http://xml2rfc.ietf.org/public/rfc/html/rfc3339.html#anchor14' target='_blank'>RFC3339</a>.
     * @return $this
     */
    public function setReadyDate($readyDate)
    {
        $this->container['readyDate'] = $readyDate;

        return $this;
    }

    /**
     * Gets completedExportsIds
     * @return \de\addvideo\client\model\CompletedExportIdDTO[]
     */
    public function getCompletedExportsIds()
    {
        return $this->container['completedExportsIds'];
    }

    /**
     * Sets completedExportsIds
     * @param \de\addvideo\client\model\CompletedExportIdDTO[] $completedExportsIds Set of reference ids to Completed exports this flavor was exported to after encoding.
     * @return $this
     */
    public function setCompletedExportsIds($completedExportsIds)
    {
        $this->container['completedExportsIds'] = $completedExportsIds;
    ...
    /**
     * Sets deleted
     * @param bool $deleted Defines whether entry is deleted or not. READ ONLY! Flag is set in db.
     * @return $this
     */
