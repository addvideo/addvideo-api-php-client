...
/**
 * ContractTypeFullDTO Class Doc Comment
 *
 * @category    Class */
 // @description ContractTypeFullDTO
/** 
 * @package     de\addvideo\client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContractTypeFullDTO implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ContractTypeFullDTO';
    ...
    /**
     * Sets label
     * @param string $label Label of contract type. String value must not exceed 32 bytes of ASCII characters.
     * @return $this
     */
