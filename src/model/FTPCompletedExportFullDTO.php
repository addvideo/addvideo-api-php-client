...
/**
 * FTPCompletedExportFullDTO Class Doc Comment
 *
 * @category    Class */
 // @description FTPCompletedExportFullDTO
/** 
 * @package     de\addvideo\client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FTPCompletedExportFullDTO implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'FTPCompletedExportFullDTO';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fullPath'] === null) {
            $invalid_properties[] = "'fullPath' can't be null";
        }
    ...
    /**
     * Sets fullPath
     * @param string $fullPath Full path of exported file at target location. String value must not exceed 512 bytes of ASCII characters.
     * @return $this
     */
