...
/**
 * ContractFullDTOListResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     de\addvideo\client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContractFullDTOListResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ContractFullDTOListResult';
    ...
    protected static $swaggerTypes = array(
        'contracts' => '\de\addvideo\client\model\ContractFullDTO[]'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contracts'] === null) {
            $invalid_properties[] = "'contracts' can't be null";
        }
    ...
    /**
     * Sets contracts
     * @param \de\addvideo\client\model\ContractFullDTO[] $contracts List of entity objects.
     * @return $this
     */
