...
/**
 * FlavorFullDTOListResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     de\addvideo\client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FlavorFullDTOListResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'FlavorFullDTOListResult';
    ...
    protected static $swaggerTypes = array(
        'flavors' => '\de\addvideo\client\model\FlavorFullDTO[]'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['flavors'] === null) {
            $invalid_properties[] = "'flavors' can't be null";
        }
    ...
    /**
     * Sets flavors
     * @param \de\addvideo\client\model\FlavorFullDTO[] $flavors List of entity objects.
     * @return $this
     */
