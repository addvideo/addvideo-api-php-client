...
/**
 * CustomerFullDTOListResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     de\addvideo\client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CustomerFullDTOListResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CustomerFullDTOListResult';
    ...
    protected static $swaggerTypes = array(
        'customers' => '\de\addvideo\client\model\CustomerFullDTO[]'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customers'] === null) {
            $invalid_properties[] = "'customers' can't be null";
        }
    ...
    /**
     * Sets customers
     * @param \de\addvideo\client\model\CustomerFullDTO[] $customers List of entity objects.
     * @return $this
     */
