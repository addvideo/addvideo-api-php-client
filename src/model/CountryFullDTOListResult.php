...
/**
 * CountryFullDTOListResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     de\addvideo\client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CountryFullDTOListResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CountryFullDTOListResult';
    ...
    protected static $swaggerTypes = array(
        'countries' => '\de\addvideo\client\model\CountryFullDTO[]'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['countries'] === null) {
            $invalid_properties[] = "'countries' can't be null";
        }
    ...
    /**
     * Sets countries
     * @param \de\addvideo\client\model\CountryFullDTO[] $countries List of entity objects.
     * @return $this
     */
