...
**name** | **string** | Name of CDN. String value must not exceed 64 bytes of ASCII characters. | 
**description** | **string** | Description. String value must not exceed 65536 bytes of ASCII characters. | [optional] 
